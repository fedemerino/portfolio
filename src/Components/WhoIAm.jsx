  ...
  return (
    <div className="homeContainer">
      <div className="whoiam">
        ...
        <p className="whoiamDescription">I'm a creative, proactive and detail-oriented Fullstack Developer based in Argentina. Currently working at Artfos and studying Systems Engineering. Feel free to take a look at my projects.</p>
